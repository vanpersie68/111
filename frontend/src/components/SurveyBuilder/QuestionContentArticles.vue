<template>
  <div>
    ...
    <label
      v-if="
        content.articleStyle !== 'Youtube' && content.articleStyle !== 'TikTok'
      "
      for="imageURL"
      >{{ $t('qContentArticles.imageLink') }}</label
    >
    <div
      v-if="
        content.articleStyle !== 'Youtube' && content.articleStyle !== 'TikTok'
    ...
    <div v-if="data.articleRetweetsOn && content.articleStyle == 'Tumblr'">
      ...
      <input
        ...
        onKeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"
        name="retweetCount"
        :placeholder="$t('qContentArticles.reblogPlaceholder')"
        v-model="retweetCount"
    ...
    <div v-if="data.articleRetweetsOn && content.articleStyle == 'Linkedin'">
      ...
      <input
        ...
        onKeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"
        name="retweetCount"
        :placeholder="$t('qContentArticles.repostPlaceholder')"
        v-model="retweetCount"
        @input="updateRetweets"
      />
    </div>
    ...
    <div v-if="data.articleSendsOn && content.articleStyle == 'Linkedin'">
      ...
      <input
        ...
        onKeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"
        name="sendCount"
        :placeholder="$t('qContentArticles.sendPlaceholder')"
        v-model="sendCount"
        @input="updateSends"
      />
    </div>
